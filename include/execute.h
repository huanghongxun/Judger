const int EXEC_OK = 0; // OK != Accepted
const int EXEC_RE = -1;
const int EXEC_TLE = -2;
const int EXEC_MLE = -3;
const int EXEC_OLE = -4;
const int EXEC_RF = -5;
const int EXEC_SF = -6;
const int EXEC_FPE = -7;

/*
 * @return execution status, one of EXEC_ macros.
 */
